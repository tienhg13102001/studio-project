/**
 * Viết lại MÔ TẢ của 5 trang dịch vụ (trừ TVC đã viết hôm 19/08).
 * Hoàn: "Câu từ đừng AI quá, rà lại toàn bộ text đi".
 *
 * DÒNG PHỤ: đã thử viết lại và Hoàn BÁC — "trả lại câu cũ cho tao, mấy câu mới
 * nghe như cứt". Đã trả về nguyên văn cũ. ĐỪNG đụng lại dòng phụ nữa; nếu có
 * sửa thì phải đưa Hoàn duyệt trước khi ghi, không tự đổi.
 *
